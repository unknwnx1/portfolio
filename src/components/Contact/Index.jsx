...
export default function ContactFormWithSocialButtons() {
  const { hasCopied, onCopy } = useClipboard('randriatman@gmail.com.com')
  ...
  const storeMessage = async (e) => {
    ...
    await api.insertData('ticket', data).then(() => {
      toast.success(
        'Successfully . I will reply to your message as soon as possible',
        {
          position: 'top-right',
          duration: 4000,
        },
